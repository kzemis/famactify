...
export const berkeleyKidsEyes: ScavengerHunt = {
  ...
  blurb: 'A five-stop walk for the youngest explorers — meet a piglet, smell a hundred roses, do a tiny senses check, find a kite catching the bay wind, and stand inside an ancient open-air theatre.',
  coverEmoji: '🐷',
  ...
  stops: [
    ...
    {
      id: 'berkeley-rose-grounding',
      order: 2,
      title: 'Rose Garden Senses Check',
      lat: 37.8845,
      lon: -122.2625,
      address: '1200 Euclid Avenue, Berkeley, CA 94708',
      clueText: 'Before leaving the rose terraces, pause for a tiny grounding mission: one colour, one smell, one sound, and one safe texture you can touch.',
      parentHint: 'This stop is intentionally slow. Let the child point, sniff, listen, and touch a leaf/bench/stone safely without picking flowers.',
      prompt: {
        kind: 'observation',
        question: 'Notice one colour, one smell, one sound, and one safe texture.',
      },
      reveal: {
        funFact: 'A senses check turns a place into a memory: the brain stores smell, sound, colour, and touch together much more strongly than a name alone.',
      },
    },
    {
